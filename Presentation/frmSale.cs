...
{
    public partial class frmSale : Form,IItemSubscriber
    {
        ...
        public frmSale(string customerID)
        {
            InitializeComponent();
        ...
        public frmSale(string mainVoucherNo,bool fromListForm)
        {
            InitializeComponent();
            //cboItemCode.DataSource = ItemService.GetAllItems();
            SetSizeNormal();
    ...
    public class ArcherDataGridView : DataGridView
    {
        ...
        public new bool ProcessRightKey(Keys keyData)
        {
            try
            {
                ...
                if (key == Keys.Enter)
                {
                    ...
                    //&& (base.CurrentCell.RowIndex == (base.RowCount - 2)
                    {
